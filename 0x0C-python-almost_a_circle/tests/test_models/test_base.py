...
class TestBase_instantiation(unittest.TestCase):
    """Unittests for Base class instantiation."""
...
class TestBase_to_json_string(unittest.TestCase):
    """Base class method unittest to_json_string."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Base class method unittest save_to_file."""
...
class TestBase_from_json_string(unittest.TestCase):
    """Base class method unittest from_json_string."""
...
class TestBase_create(unittest.TestCase):
    """Base class method unittest create_*."""
...
class TestBase_load_from_file(unittest.TestCase):
    """Base class method unittest load_from_file_method."""
...
class TestBase_save_to_file_csv(unittest.TestCase):
    """Base class method unittest save_to_file_csv."""
...
class TestBase_load_from_file_csv(unittest.TestCase):
    """Base class method unittest load_from_file_csv."""

    @classmethod
    def tearDown(self):
        """Deletes any files created."""
        try:
            os.remove("Rectangle.csv")
        except IOError:
            pass
