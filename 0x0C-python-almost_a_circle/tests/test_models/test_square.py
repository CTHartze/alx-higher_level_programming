#!/usr/bin/python3
# test_square.py
"""Defines unittests for models/square.py module.
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for Square class instantiation."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for Square class size initialization."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for Square x attribute initialization."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for Square y attribute initialization."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for attribute initialization of Square order."""
...
class TestSquare_area(unittest.TestCase):
    """Square class method unittest area."""
...
class TestSquare_stdout(unittest.TestCase):
    """Square class method unittest __str__ and display."""
...
class TestSquare_update_args(unittest.TestCase):
    """Square class method unittest update_args."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Square class method unittest update_kwargs."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Square class method unittest to_dictionary."""
