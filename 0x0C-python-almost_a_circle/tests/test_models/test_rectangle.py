#!/usr/bin/python3
# test_rectangle.py
"""Defines unittests for models/rectangle.py module.
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for Rectangle width attribute iniatization."""
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for Rectangle height attribute initialization."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for Rectangle x attribute initialization."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for Rectangle y attribute initialization."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests attribute initialization for Rectangle order."""
...
class TestRectangle_area(unittest.TestCase):
    """Rectangle class method unittest area."""
...
class TestRectangle_stdout(unittest.TestCase):
    """Rectangle class method unittest __str__ and display."""

    @staticmethod
    def capture_stdout(rect, method):
        """Records and returns text printed to stdout.

        Args:
            rect (Rectangle): Rectangle to print to stdout.
            method (str): Refers to the method to run on rect.
        Returns:
            Text is printed to stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Rectangle class method unittest update_args_*."""
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Rectangle class method unittest update_kwargs_*."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Rectangle class method unittest to_dictionary."""
