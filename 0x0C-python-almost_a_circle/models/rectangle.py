...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """Gets/Sets Rectangle's x coordinate."""
        return self.__x
    ...
    @property
    def y(self):
        """Gets/Sets Rectangle's y coordinate."""
        return self.__y
    ...
    def display(self):
        """Prints Rectangle using the `#` char."""
    ...
    def to_dictionary(self):
        """Return Rectangle's dictionary representation."""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
    ...
    def __str__(self):
        """Returns Rectangle's print() and str() representation."""
